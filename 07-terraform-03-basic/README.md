...
```
root@vagrant:~/7-2# terraform workspace list
  default
* prod
  stage
```
...
root@vagrant:~/7-2# terraform plan
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.vm-test2["vm1"] will be created
  ...
  # yandex_compute_instance.vm-test2["vm2"] will be created
  + resource "yandex_compute_instance" "vm-test2" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
  ...
  # yandex_compute_instance.vm-test2["vm3"] will be created
  + resource "yandex_compute_instance" "vm-test2" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
